...
<details>
 ...
 Glow effect it takes the Glow strenght and adds a frestnel effekt and multiplies it to create a glow effect and you 
 get the color and applies a pulsing glow while its filling up
   <table>
  <tr>  
